  ...
  return (
    <>
      <div className="min-h-full">
                  ...
                  <div className="mt-3 space-y-1">
                    {userNavigation.map((item) => (
                      <Disclosure.Button
                        ...
                        as="a"
                        href={item.href}
                        className="block px-4 py-2 font-medium text-gray-500 text-base hover:bg-gray-100 hover:text-gray-800"
                      >
                        {item.name}
                      </Disclosure.Button>
                    ))}
        ...
        <div className="overflow-auto py-10 md:mx-auto md:max-w-3xl">
          <main>
